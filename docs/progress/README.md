...
- 阶段六：进行中——已完成债券发行批次恢复、银行到账恢复、逾期率/存贷比/挤兑压力触发、连续三日危机恢复、全局日结阶段日志、持久化银行权益账本、手续费收入、逾期损失准备、坏账核销、政府资本补充收据、股票成交、公开收购、债券兑付、分红和拍卖竞价的可重试资金凭证；完整金融托管状态机及供应订单待处理日志仍待收敛。
