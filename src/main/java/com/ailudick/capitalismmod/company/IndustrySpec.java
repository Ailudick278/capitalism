 ...
 * @param inputs  item id -> quantity consumed per production batch
 * @param outputs item id -> quantity produced per production batch
 * @param income  USD operating income per production batch (finance uses a special formula)
 */
