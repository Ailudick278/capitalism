...
public class NetworkHandler {
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(SyncCompanySiteOverlayPayload.TYPE, SyncCompanySiteOverlayPayload.STREAM_CODEC, ClientPayloadHandler::handleSyncCompanySites);
        registrar.playToClient(SyncLogisticsNodeOverlayPayload.TYPE, SyncLogisticsNodeOverlayPayload.STREAM_CODEC, ClientPayloadHandler::handleSyncLogisticsNodes);
