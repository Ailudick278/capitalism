...
public class Config {
    ...
    public static final ModConfigSpec.IntValue BANK_BAD_DEBT_WRITE_OFF_DAYS = BUILDER
            .comment("Days after bank-loan maturity before a long-overdue debt is written off as a realized bank loss.")
            .defineInRange("bankBadDebtWriteOffDays", 90, 1, 3650);
    ...
    public static final ModConfigSpec.DoubleValue COMPANY_LIQUIDATION_RECOVERY_RATE = BUILDER
            .comment("Fraction of inventory and equipment market value recovered during company liquidation.")
            .defineInRange("companyLiquidationRecoveryRate", 0.70, 0.0, 1.0);
    ...
    public static final ModConfigSpec.IntValue STOCK_ORDER_EXPIRY_DAYS = BUILDER
