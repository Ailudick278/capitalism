...
public record TaxPayment(String id, String billId, UUID taxpayerUuid, String currencyId,
                         long amount, long paidAt, String settlementReference) {
    public TaxPayment(String id, String billId, UUID taxpayerUuid, String currencyId,
                      long amount, long paidAt) {
        this(id, billId, taxpayerUuid, currencyId, amount, paidAt, "");
    }
