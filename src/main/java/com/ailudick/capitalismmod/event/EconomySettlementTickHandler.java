...
public final class EconomySettlementTickHandler {
    ...
    private static void settleOneDay(net.minecraft.server.MinecraftServer server, long settlementDay) {
        ...
        if (journal.isDayComplete(settlementDay)) return;
        ...
        if (!journal.isCompleted(settlementDay, "credit-and-securities")) {
            ...
            CentralBankFacilityService.settleDaily(server, settlementDay);
